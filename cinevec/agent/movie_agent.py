...
def find_similar_movies(
    ...
    return search.similar_search(
        ...
        rating_min=rating_min, rating_max=rating_max, min_votes=min_votes)
...
def search_movies(
    ...
    limit = clamp(limit)
    filters = dict(genre=genre, language=language, year_min=year_min,
                   year_max=year_max, rating_min=rating_min,
                   rating_max=rating_max, min_votes=min_votes)
